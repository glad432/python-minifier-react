...
import blogJson from "../Article/blog.min.json";
...
function Article() {
  ...
  return (
    <div className="grid place-items-center pb-[25px]">
      <span
        id="show-btn"
        className="relative cursor-pointer text-center text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 font-bold text-center"
